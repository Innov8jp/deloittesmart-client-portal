...
# --- ELIGIBILITY SELF-CHECK MODE ---
    ...
    if st.button("Calculate Score & Download Report"):
        ...
        status = (
            "🟢 Highly Eligible" if score >= 85 else
        ...
        pdf.cell(0, 10, "DeloitteSmart™ Subsidy Eligibility Report", ln=1, align="C")
        pdf.ln(5)
        ...
        pdf.ln(5)
        pdf.multi_cell(0, 8, f"Eligibility Score: {score}% – {status}")
        pdf.ln(5)
        pdf.multi_cell(0, 8, (
            f"Age: {age}\n"
